...
public class ProgramsService {
    ...
    public Map<String, Object> getDhis2Programs(String instanceUuid, Integer page, Integer pageSize, String q, String programType) throws Exception {
