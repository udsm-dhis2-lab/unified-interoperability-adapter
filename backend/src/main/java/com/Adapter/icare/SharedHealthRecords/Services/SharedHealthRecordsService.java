...
public class SharedHealthRecordsService {
        ...
        public List<DiagnosticReport> getDiagnosticReportsByCategory(String encounterId, String category)
                        throws Exception {
        ...
        private BigDecimal getNestedExtensionValueQuantityValue(Procedure procedure, String parentUrl,
                        String childUrl) {
                if (procedure.hasExtension()) {
